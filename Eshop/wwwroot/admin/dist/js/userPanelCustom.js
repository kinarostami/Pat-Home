...
function received(orderId) {
    Question(`/UserPanel/Orders/Show/${orderId}/ReceivedProducts`, "آیا از انجام عملیات اطمینان دارید ؟", "");
};
function deleteCard(id) {
    deleteItem(`/Seller/Cards/DeleteCard?cardId=${id}`, "امکان حذف کارت وجود ندارد");
}
        ...
        if (typeof data === 'object' && data !== null) {
            ...
            `);
                for (var item in data.newNotifications) {
                    ...
                    <li><a href="/Profile/notifications"><i class="fa fa-bell-o text-warning"></i> ${notification.notificationTitle}</a></li>`);
                }
            }
        }
    });
